...
describe('Todo list evaluation', () => {
  ...
  describe('Deve haver um input com o id="texto-tarefa" onde o usuário poderá digitar o nome do item que deseja adicionar à lista', () => {
  ...
  describe('Deve haver uma lista ordenada de tarefas com o id="lista-tarefas"', () => {
    it('Será verificada a existência de um elemento `ol` com o id `lista-tarefas`', () => {
      cy.get(TODO_LIST_SELECTOR).should('exist');
    });
  });

  describe('Deve haver um botão com id="criar-tarefa" e, ao clicar nesse botão, um novo item deverá ser criado ao final da lista e o texto do input deve ser limpo', () => {
  ...
  describe('Os itens da lista de tarefas devem ser ordenados por ordem de criação', () => {
  ...
  describe('Ao clicar em um item da lista, altere a cor de fundo do item para cinza rgb(128,128,128)', () => {
  ...
  describe('Deve haver um botão com `id="apaga-tudo"`que quando clicado deve apagar todos os itens da lista', () => {
  ...
  describe('Deve haver um botão`id="remover-finalizados"`que quando clicado remove **somente** os elementos finalizados da sua lista', () => {
  ...
  describe('Adicione dois botões, um com `id="mover-cima"` e outro com `id="mover-baixo"`, que permitam mover o item selecionado para cima ou para baixo na lista de tarefas', () => {
  ...
  describe('Adicione um botão com `id="remover-selecionado"` que, quando clicado, remove o item selecionado', () => {
